...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nested functions are able to reach out to its outer function(s) to grab a piece of information, this is when a closure happens
// because 'internal' was created in the outer function 'myFunction', 'nestedFunction' can reach up to grab 'internal'
...
function summation(number) {
  ...
  const value = numbers.reduce(function(acc, item){
    return acc + item;
  },0)
  return value;
}
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      ...
      //newArray.push(item.scientific_name);
    })
    return newArray;
  }
  ...
  */
  ...
  function USApop(array){
    const USA = array.reduce(function(acc, item){
